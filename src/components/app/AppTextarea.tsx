import type { TextAreaProps, TextFieldProps } from '@heroui/react'
...
export interface AppInputProps extends TextFieldProps {
  ...
  placeholder?: string
  inputProps?: Omit<TextAreaProps, 'placeholder'>
  prefix?: ReactNode
  suffix?: ReactNode
}
  ...
  return (
    <TextField {...rest}>
      ...
      <InputGroup variant={variant}>
        ...
        <InputGroup.TextArea {...inputProps} placeholder={placeholder} />
