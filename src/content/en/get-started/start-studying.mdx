...
Once your deck has facts and cards (see [Create your deck](/guide/get-started/create-your-deck)), open a deck and begin review. Rete picks the most urgent due card—optionally filtered by [tag](/guide/key-concepts/tags)—and walks you through three steps: **recall**, **show answer**, and **rate difficulty**.
...
Repeating this loop is how Rete trains long-term retention—not by rereading content passively.
