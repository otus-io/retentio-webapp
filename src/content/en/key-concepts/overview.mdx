...
To use Rete more effectively, we recommend first understanding a few core concepts. Rete’s content organization, learning flow, and review system are all built around these foundational ideas.
...
The pages below explain how **decks**, **fields**, **facts**, **cards**, and **tags** work in Rete.
...
3. **Study** — Rete picks the most urgent due card in the deck; you see front, then back, and your rating updates the schedule.
