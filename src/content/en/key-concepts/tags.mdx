...
1. **By name when you create content** — pass tag **names** (strings) when creating a deck or when adding facts. If a name does not exist yet, Retentio creates the tag for you and links it.
