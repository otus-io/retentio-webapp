...
Controlled research on optimal time allocation remains sparse; however, a meta-analysis of twenty-one extensive reading studies (_N_ = 1,268) reported _d_ = 1.32 for vocabulary gains from reading alone—comparable to SRS effect sizes.
