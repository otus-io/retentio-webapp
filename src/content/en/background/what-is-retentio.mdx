...
- **Help on a miss** — generate a short explanation, example sentence, or follow-up in context when you get something wrong, instead of showing only a static back-of-card answer.
