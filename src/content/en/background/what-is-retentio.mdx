...
- **Creation from sources** — turn PDFs, articles, or textbooks into Q&A cards, clozes, distractors, and alternate phrasings, often with example sentences that show how terms are used in context.
- **Richer cards** — add example sentences, usage notes, mnemonics, images, or aligned audio (including sentence-level playback for language study).
