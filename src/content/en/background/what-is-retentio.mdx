...
Retentio started with a problem its founder noticed as a graduate student. Many students around him were using spaced-repetition apps for two things—learning a new language, or memorizing difficult medical terminology. The method worked; the tools often did not.
