...
Retentio started with a problem its founder noticed as a graduate student. Many PhD students around him were using spaced-repetition apps to pick up new languages alongside their research—reading papers in German, following talks in Japanese, or preparing for fieldwork abroad. Medical students faced a similar need: memorizing large volumes of difficult terminology for anatomy, pharmacology, and clinical exams. The method worked; the tools often did not.
