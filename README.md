...
- **PR review** (`.github/workflows/pr-review.yml`): on non-draft PR **opened** / **synchronize**, runs Claude Code auto-review via `anthropics/claude-code-action`. Set repository secret **`ANTHROPIC_API_KEY`** and install the [Claude GitHub App](https://github.com/apps/claude).
